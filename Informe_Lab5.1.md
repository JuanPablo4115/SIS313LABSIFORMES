...
sudo netplan apply
```
### 4.3 Diagrama de Configuración de Red
...
### 5.2 Generación de Clave SSH (PC Anfitriona Windows)
...
### 5.3 Copia de Clave Pública a los Servidores
...
### 5.4 Configuración del Servidor SSH (En el WEB y en DB)
...
### 6.4 Tabla Comparativa de Políticas UFW
...
### 7.1 ¿Por qué hardening del kernel?
...
### 8.1 ¿Qué es TLS y por qué es importante?
...
### 8.3 Creación del Sitio Web del Grupo
...
### 8.4 Generación del Certificado SSL Autofirmado
...
### 8.5 Configuración del Virtual Host con HTTPS
...
### 9.2 Script de Seguridad mysql_secure_installation
...
### 9.3 Restricción de bind-address
...
### 9.4 Creación de Usuario y Base de Datos
...
### 9.5 Diagrama de Seguridad de MariaDB
...
### 10.4 Creación del Archivo de Zona
...
### 10.6 Deshabilitar systemd-resolved
...
### 10.7 Configuración DNS en PC Anfitriona (Windows)
...
### 12.1 Verificar SSH en puerto 2222
...
### 12.2 Prueba redirección HTTP → HTTPS
...
### 12.3 Verificar cabeceras de seguridad
...
### 12.4 Prueba TLS 1.2 (debe FUNCIONAR)
...
### 12.5 Prueba TLS 1.1 (debe FALLAR)
...
### 12.6 Verificar puerto 3306 bloqueado desde exterior
